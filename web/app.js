...
const I18N = {
  cs: {
    ...
    fineprint: "Hobby projekt, ne oficiální zdroj — berte to jako vodítko, ne záruku.",
  ...
  en: {
    ...
    fineprint: "A hobby project, not an official source — treat it as a guide, not a guarantee.",
