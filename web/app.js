...
const I18N = {
  cs: {
    ...
    coverageNote: "Plné rámečky jsou interaktivní — přibližte se do nich. Čárkované byly spočítané pro 12. 8. 2026, ale kvůli velikosti dat už tu nejsou.",
  ...
  en: {
    ...
    coverageNote: "Solid outlines are interactive — zoom into one. Dashed ones were computed for 12 Aug 2026 but are no longer hosted, for size reasons.",
...
map.on("load", async () => {
  ...
  map.addLayer({
    ...
    type: "symbol",
    source: "coverage",
    // "computing" only, never "archived". An hourglass on a region that was
    // computed and then retired would promise something that is not coming.
    filter: ["==", ["get", "status"], "computing"],
    layout: {
