...
const REGIONS = [
  ...
  { id: "bruntal", url: "bruntal.pmtiles", maxUrl: "bruntal_max.pmtiles" },
  ...
  { id: "chlumetin", url: "chlumetin.pmtiles", maxUrl: "chlumetin_max.pmtiles" },
  ...
  { id: "detenice", url: "detenice.pmtiles", maxUrl: "detenice_max.pmtiles" },
  ...
  { id: "hranice", url: "hranice.pmtiles", maxUrl: "hranice_max.pmtiles" },
  ...
  { id: "korenec", url: "korenec.pmtiles", maxUrl: "korenec_max.pmtiles" },
  { id: "korycany", url: "korycany.pmtiles", maxUrl: "korycany_max.pmtiles" },
  { id: "krnov", url: "krnov.pmtiles", maxUrl: "krnov_max.pmtiles" },
  { id: "kvasiny", url: "kvasiny.pmtiles", maxUrl: "kvasiny_max.pmtiles" },
  { id: "lesany", url: "lesany.pmtiles", maxUrl: "lesany_max.pmtiles" },
  { id: "liberec", url: "liberec.pmtiles", maxUrl: "liberec_max.pmtiles" },
  { id: "licomelice", url: "licomelice.pmtiles", maxUrl: "licomelice_max.pmtiles" },
  { id: "litvinov", url: "litvinov.pmtiles", maxUrl: "litvinov_max.pmtiles" },
  { id: "louny", url: "louny.pmtiles", maxUrl: "louny_max.pmtiles" },
  { id: "marianske-lazne", url: "marianske-lazne.pmtiles", maxUrl: "marianske-lazne_max.pmtiles" },
  { id: "medlov", url: "medlov.pmtiles", maxUrl: "medlov_max.pmtiles" },
  ...
  { id: "mrakotin", url: "mrakotin.pmtiles", maxUrl: "mrakotin_max.pmtiles" },
  ...
  { id: "ostrov", url: "ostrov.pmtiles", maxUrl: "ostrov_max.pmtiles" },
  { id: "pardubice", url: "pardubice.pmtiles", maxUrl: "pardubice_max.pmtiles" },
  { id: "pelhrimov", url: "pelhrimov.pmtiles", maxUrl: "pelhrimov_max.pmtiles" },
  { id: "pisek", url: "pisek.pmtiles", maxUrl: "pisek_max.pmtiles" },
  { id: "plasy", url: "plasy.pmtiles", maxUrl: "plasy_max.pmtiles" },
  ...
  { id: "ustek", url: "ustek.pmtiles", maxUrl: "ustek_max.pmtiles" },
  { id: "usti", url: "usti.pmtiles", maxUrl: "usti_max.pmtiles" },
  { id: "usti-orlici", url: "usti-orlici.pmtiles", maxUrl: "usti-orlici_max.pmtiles" },
  { id: "varnsdorf", url: "varnsdorf.pmtiles", maxUrl: "varnsdorf_max.pmtiles" },
  { id: "vrchlabi", url: "vrchlabi.pmtiles", maxUrl: "vrchlabi_max.pmtiles" },
  { id: "vroutek", url: "vroutek.pmtiles", maxUrl: "vroutek_max.pmtiles" },
...
const I18N = {
  cs: {
    ...
    note2: "Model povrchu: lidar ČÚZK — obsahuje stavby dokončené nejméně do roku 2022 (ověřeno na budovách z let 2018 a 2022). Novější mohou chybět. U hranic chybí zahraniční terén, tam může mapa slunce nadhodnocovat.",
    ...
    fineprint: "Hobby projekt bez záruky. Autor neručí za přesnost dat ani za rozhodnutí učiněná podle nich. Mapa nenahrazuje pohled na místo.",
    reportLink: "Našli jste chybu?",
  ...
  en: {
    ...
    note2: "Surface model: ČÚZK national lidar — includes construction through at least 2022 (checked against buildings finished in 2018 and 2022). Anything newer may be missing. Near the borders foreign terrain is absent, so the map can be over-optimistic there.",
    ...
    fineprint: "A hobby project, provided without warranty. The author accepts no liability for the accuracy of the data or for decisions based on it. It does not replace looking at the place itself.",
    reportLink: "Found a mistake?",
